...
import com.cgq.gui.StdDraw;
import com.cgq.io.StdArrayIO;
import com.cgq.io.StdOut;

/**
 * @comment
 * @author cgqfzy
 * @version 1.0
 * @date Apr 9, 2015 9:48:29 PM
 */
public final class StdStats {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("sum " + sum(a));
        StdOut.println("stddev " + stddev(a));
        StdOut.println("var " + var(a));
        StdOut.println("stddevp " + stddevp(a));
        StdOut.println("varp " + varp(a));
    }
}