...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            StdOut.print( uniform(100));
            StdOut.print(uniform(10.0, 99.0));
            StdOut.print(bernoulli(.5));
            StdOut.print(gaussian(9.0, .2));
            StdOut.print( discrete(t));
            StdOut.println();
        }
